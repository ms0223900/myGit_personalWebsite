...
<head>
    ...
    <style>
        .eatDetail .banner .banner-txt .count-buy .count-qty .plusAndMinus {
            ...
            <div class="banner-txt part-md-6 part-lg-6">
                ...
                <div class="count-buy clearfix">
                    ...
                    <div class="count-qty line-block">
                        <div class="qty-cut plusAndMinus" id="qty-cut" name="qty-cut">-</div>
                        <input type="text" class="qty" id="qty" name="quantity" value="1">
                        <div class="qty-add plusAndMinus" id="qty-add" name="qty-add">+</div>
                    </div>    
                </div>
                <div class="count-btn clearfix">
                    <div class="add-cart mainBTN cart_icon" name="add-cart" id="A0<?php echo $dishesRow->meal_No; ?>">
                    ...
                    <div class="go-cart subBTN" name="go-cart" id="buyNow" mealId="<?php echo $dishesRow->meal_No; ?>">
                        <input type="hidden" value="<?php echo $dishesRow->meal_Name; ?>|<?php echo $dishesRow->meal_Pic; ?>|<?php echo $dishesRow->meal_Price; ?>|1">
                        <i class="fas fa-shopping-bag"></i>立即預訂
            ...
            ?>
                <div class="member-msg">
                        <div class="member-data clearfix">
                            <div class="member-pic fl">
                                <figure class="member-img fl">
                                    <img src="images/member_pic/<?php echo $memPic ?>">
                                </figure>
...
<script>
    ...
    var logged = false;
	document.getElementsByClassName('go-cart ')[0].onclick =  function() {
        if(logged) {
            var dishes = this.children[0].value;
            var mealId = this.getAttribute('mealId');
            addItem(mealId, dishes);
	...
	if(isset($_SESSION['member_Id'])) {
		echo "document.getElementsByClassName('go-cart ')[0].onclick =  function() {
            var dishes = this.children[0].value;
            var mealId = this.getAttribute('mealId');
            addItem(mealId, dishes);
            location.href = 'shopping_cart.php';
