...
try {
    ...
    (NULL, '$createG->groupon_Name', '$tagNo', '$memId', DATE_ADD(NOW(),INTERVAL '$createG->startDate' DAY) ,DATE_ADD(NOW(),INTERVAL '$createG->endDate' DAY), '$createG->groupon_Bonus', '$createG->groupon_MemberNeed', '0', '$discount')";
