                                    ...
                                    <div class="shareInfo-wrapper clearfix">
                                        ...
                                        <div class="shareInfo-wrapper clearfix">
                                            <div class="QRcode grid-12 grid-md-6">
                                                ...
                                                <div class="QR-container">
                                                    <div class="pic">
                                                        <img src="http://chart.apis.google.com/chart?cht=qr&choe=UTF-8&chs=300x300&chl=http://140.115.236.72/demo-projects/CD103/CD103G3/6-1_grouponDetail.php?no=${myGrouponSearchR[i][0]}" alt="">
                                                    </div>
                                                </div>
                                            </div>
