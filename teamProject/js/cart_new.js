...
function doFirst(){
    ...
    for(var i in itemArray) {
        ...
        if(itemInfo != null) {
            ...
            document.getElementsByClassName('shopping_sum_t')[0].innerText = "NT$ " + Math.floor(total);
            document.getElementsByClassName('shopping_sum_t')[1].innerText = "NT$ " + Math.floor(total);

            Bonus = memberBonus > total*0.2 ? total*0.2 : memberBonus; 
            document.getElementsByClassName('groupon_bonus_t')[0].innerText = "NT$ " + Math.floor(Bonus);
            document.getElementsByClassName('groupon_bonus_t')[1].innerText = "NT$ " + Math.floor(Bonus);

            document.getElementsByClassName('memOrder_amount_t')[0].innerText = "NT$ " + Math.floor(total - Bonus);
            document.getElementsByClassName('memOrder_amount_t')[1].innerText = "NT$ " + Math.floor(total - Bonus); 
...
function windowMove2(){
    ...
    var data_info = "memOrderAmount=" + Math.floor(total - Bonus) + //訂單金額
                    ...
                    "&memberBonus=" + Math.floor(Bonus); //會員所消耗購物金
    // alert(data_info);
    xhr.send(data_info);
