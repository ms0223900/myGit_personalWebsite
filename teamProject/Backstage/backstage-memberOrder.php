                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php 
                                $status  = $memorderrow->memOrder_status; 
                                if($status == 'done'){
                                    echo "已取餐";
                                }else{
                                    echo "未取餐";
                            ...
                            <td>
                                <i class="fas fa-pencil-alt touch" data-toggle="modal" data-target="#memOrder" orderNo="<?php echo $memorderrow->memOrder_No;?>"></i>
                                <div class="modal fade" id="memOrder" tabindex="-1" role="dialog" aria-labelledby="memOrderTitle" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form>
                                                    ...
                                                    <div class="d-flex form-group">
                                                        <label for="memberNo" class="col-form-label title-width">會員暱稱</label>
